...
class FormatterTestCase(TestCase):
    ...
    def setUp(self):
        ...
        salary_def = Definition.objects.get_by_natural_key('tests',
            'title', 'salary')
        boss_def = Definition.objects.get_by_natural_key('tests',
            'title', 'boss')
        ...
        ConceptDefinition(concept=self.c,
                definition=title_def, order=1).save()
        ConceptDefinition(concept=self.c,
                definition=salary_def, order=2).save()
        ConceptDefinition(concept=self.c,
                definition=boss_def, order=3).save()
